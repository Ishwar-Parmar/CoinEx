...
import 'package:exchange/coinbase_rest_apis.dart';
...
class _CryptoPricePairState extends State<CryptoPricePair> {
  ...
  void initState() {
    ...
    Timer.periodic(
        ...
        (Timer t) => setState(() {
              ...
              print('value : $get_price_from_trading_pair');
              print('value : $baseToFiatPrice');
            }));
  }
  ...
  Widget build(BuildContext context) {
    var children2 = <Widget>[
      ...
      const Text("➡",
          style: TextStyle(color: primaryColorA, fontWeight: FontWeight.bold)),
      FutureBuilder<List<String>>(
      ...
      FutureBuilder<String>(
        future: get_price_from_trading_pair("$_baseCurrency", "$_fiatCurrency"),
        builder: (context, snapshot) {
